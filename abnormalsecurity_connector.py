...
def main():
    ...
    if username and password:
        try:
            ...
            r = requests.get(login_url, verify=False, timeout=REQUEST_TIMEOUT)
            ...
            r2 = requests.post(login_url, verify=False, data=data, headers=headers, timeout=REQUEST_TIMEOUT)
